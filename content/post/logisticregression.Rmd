...
Holding all other variables constant, this fitted model predicts that the odds of detecting a male are 1.38 times higher for penguins on Dream Island than on Biscoe.


The odds of detecting a male increased 1.005 times (95%CI 1.003–1.007) for each one-unit
