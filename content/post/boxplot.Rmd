...
Step 3: Change the plotting order, colours, legend position and x-axis order
...
step 5: Change the legend order similar to plot order: under themes `fill=guide_legend(reverse=FALSE)`
